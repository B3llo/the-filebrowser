...
const allItems = ref<StarredFile[]>([]);
...
// Re-sync whenever a star/unstar happens
...
const sortedItems = computed(() => {
  ...
  return list.sort((a, b) => {
    ...
    return (a.starredAt - b.starredAt) * dir;
  });
});
